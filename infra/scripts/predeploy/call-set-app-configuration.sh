...
echo "Calling set-app-configuration.ps1 for group:'$resourceGroupName'..."

pwsh ./infra/scripts/predeploy/set-app-configuration.ps1 -ResourceGroupName $resourceGroupName -NoPrompt
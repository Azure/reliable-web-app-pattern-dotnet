    ...
    public class ConcertDataContext : DbContext
    {
        ...
        public void Initialize()
        {
            ...
            var artists = new[] {
                ...
                new { Name = "Fadime Dogan", Genre = "Pop", Tour = "Galactic Symphony: A Musical Odyssey through the Stars", Description = "Galactic Symphony is a fictional British band formed in 2007. The band featuresFadime Dogan (lead vocals, electric guitar, acoustic guitar, drums) and includes guests featuring vocals, keyboard, piano, synthesizer. In her latest album, she wanted to experiment with new sounds and styles, so she decided to explore different rhythms, instruments and cultures which gave her a different touch to her music. She fuses pop, rock, and latin rhythms, to create her own unique sound." },

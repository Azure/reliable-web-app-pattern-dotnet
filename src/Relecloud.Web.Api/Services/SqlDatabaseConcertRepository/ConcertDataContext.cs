    ...
    public class ConcertDataContext : DbContext
    {
        ...
        public void Initialize()
        {
            ...
            var artists = new[] {
                ...
                new { Name = "Larissa Sevilla", Genre = "Pop", Tour = "Eclectic Stargazer Extravaganza", Description = "Eclectic Stargazer Extravaganza\", Description = \"Larissa Sevilla (born June 16, 1958) is a fictional musician and singer-songwriter. After completing her studies in jazz music history, she moved to Europe to pursue a career in music. She made a name for herself on the local music scene and eventually caught the attention of a record label." },

namespace Relecloud.Web.Services.PaymentGatewayService
{
    public class MockTicketServiceAuthenticationHandler : DelegatingHandler
    {
        private readonly string _escapedKey;

        public MockTicketServiceAuthenticationHandler(string key)
        {
